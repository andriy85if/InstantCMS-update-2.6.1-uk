<?php
    ...
    define('LANG_FILTER_SAVE_DIFF_ORDER',    'Зберігати різноманітне сортування');
    ...
    //PARSERS
    define('LANG_PARSER_BITMASK_MAX',        'Максимальна кількість пунктів списку');
    define('LANG_PARSER_BITMASK_MAX_HINT',   'в передвстановлених значеннях');
    ...
    define('LANG_PARSER_CITY_OUTPUT_STRING_HINT', 'Наприклад, "{country}, {city}", де country і city системні імена полів. Корисно використовувати, відключаючи для виведення інші поля групування, показуючи потрібні значення в цьому полі. Якщо не вказано - виводиться значення поточного поля.');
    ...
    define('LANG_PARSER_AGE_FROM_DATE',      'Рахувати від вказаної дати');
    define('LANG_PARSER_AGE_FROM_DATE_HINT', 'Якщо не вказано, відлік буде вестись від поточного значення часу');
    ...
    define('LANG_PARSER_IMAGE_SPELL',        'зображення|зображення|зображень');
    define('LANG_PARSER_IMAGES',             'Набір зображень');
    define('LANG_PARSER_IMAGE_ALLOW_IMPORT_LINK', 'Дозволити додавання за посиланням');
    define('LANG_PARSER_FIRST_IMAGE_EMPHASIZE', 'Виділяти перше зображення в дописі');
    define('LANG_PARSER_IMAGE_MAX_COUNT',    'Максимальна кількість зображень');
    define('LANG_PARSER_IMAGE_MAX_COUNT_HINT', 'Максимум %s');
	define('LANG_PARSER_SMALL_IMAGE_PRESET', 'Пресет мініатюр');
    define('LANG_PARSER_IMAGE_SIZE_UPLOAD',  'Створювати прев’ю-зображення');
    define('LANG_PARSER_IMAGE_SIZE_TEASER',  'Розмір в списку');
    define('LANG_PARSER_IMAGE_SIZE_FULL',    'Розмір в дописі');
    define('LANG_PARSER_IMAGE_SIZE_MODAL',   'Розмір в дописі при кліку');
    ...
    define('LANG_PARSER_FILE_LABEL_NAME',    'Ім’я файлу');
    ...
    define('LANG_PARSER_ADD_FROM_LINK', 'додати за посиланням');
    define('LANG_PARSER_ENTER_IMAGE_LINK', 'Введіть посилання на зображення');
    define('LANG_OR', 'або');
    define('LANG_BEGIN_TYPING', 'Почніть вводити або виберіть зі списку');
    ...
    define('ERR_MODEL_NOT_FOUND',			 'Не знайдено модель даних або вона недоступна для читання');
    define('ERR_TEMPLATE_NOT_FOUND', 		 'Не знайдено шаблон для відображення або він недоступний для читання');
    define('ERR_LIBRARY_NOT_FOUND', 		 'Бібліотеку не знайдено або недоступна для читання');
	define('ERR_FILE_NOT_FOUND',             'Файл не знайдено');
    define('ERR_CLASS_NOT_FOUND', 		 	 'Клас не знайдено або недоступний для читання');
    ...
    define('ERR_SEARCH_TITLE',               'Пошук');
    define('ERR_SEARCH_QUERY_INPUT',         'Що шукаємо?');
    ...
    define('LANG_SUBMIT_NOT_SAVE',			 'Покинути сторінку? Можливо, внесені зміни не збережуться.');
    ...
    define('LANG_HITS_SPELL',                'перегляд|перегляди|переглядів');
	define('LANG_HITS',                      'Перегляди');
    define('LANG_GUEST',                     'Гість');
    ...
    define('LANG_SUCCESS_MSG',               'Дані успішно збережені');
